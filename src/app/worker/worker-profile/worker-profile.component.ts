...
export class WorkerProfileComponent implements OnInit {
  ...
  onChangePassword() {
    ...
    if (newpassword === confirmpassword && newpassword != '') {
      ...
      this.user.updatePassword(newpassword).then(() => {
        this.openSnackBar("Your Password has been updated","Done")
  ...
  onSaveWorker() {
    ...
    this.workerService.updateWorker(this.workerkey, workerupdated).then(()=>{
      this.openSnackBar('Your Profile has been updated','Done')
  });
  }
